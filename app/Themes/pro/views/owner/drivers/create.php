...
<head>
    ...
    <title>Add Driver - TLCDesk</title>
...
<body class="bg-gray-100 flex h-screen overflow-hidden">
    ...
    <div class="flex flex-col flex-1 w-0 overflow-hidden">
        ...
        <main class="flex-1 p-6">
            <h1 class="text-2xl font-bold mb-4">Add New Driver</h1>
            <div class="bg-white p-6 rounded shadow max-w-lg">
                <form action="/owner/drivers/store" method="POST" class="space-y-4">
                    <?= csrf_field() ?>
                    <div>
                    ...
                    <div class="flex justify-end">
                        <a href="/owner/drivers" class="mr-4 text-gray-600 hover:underline py-2">Cancel</a>
